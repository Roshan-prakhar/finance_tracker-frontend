                ...
                <div className="relative z-10 w-full max-w-lg">
                    ...
                    <div className="bg-white rounded-3xl shadow-2xl overflow-hidden" style={{boxShadow: '0 20px 60px rgba(22,163,74,0.12)'}}>
                        ...
                        <div className="p-8 md:p-10">
                            ...
                            <p className="text-sm text-gray-400 mb-7">Set up your profile to get started</p>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-800 bg-gray-50 focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-500/10 focus:bg-white transition-all"
                                    />
                                </div>
